              ...
              <v-row dense class="align-center">
                <v-col cols="12" sm="5">
                  ...
                  >
                    ...
                    <v-date-picker v-model="form.firstDate" no-title scrollable>
                      <v-spacer></v-spacer>
                      <v-btn
                        text
                        color="primary"
                ...
                <v-col cols="12" sm="5">
                  ...
                  >
                    ...
                    <v-date-picker v-model="form.lastDate" no-title scrollable>
                      <v-spacer></v-spacer>
                      <v-btn text color="primary" @click="lastDateMenu = false">
                        Cancel
                      </v-btn>
                      <v-btn
                        text
